...
const eyeColor = {
  ...
  brown: [],
  red: [],
 'blue-gray': []  // Poiché "blue-gray" contiene un trattino, è necessario utilizzare le virgolette per la proprietà.
};

// Ora l'oggetto "eyeColor" ha le proprietà con array vuoti associati.
